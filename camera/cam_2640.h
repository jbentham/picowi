...
{ 0x5a, 0xC8 }, { 0x5b, 0x96 }, { 0x5c, 0x00 }, { 0xd3, 0x00 }, { 0xc3, 0xed }, \
{ 0x7f, 0x00 }, { 0xda, 0x00 }, { 0xe5, 0x1f }, { 0xe1, 0x67 }, { 0xe0, 0x00 }, \
{ 0xdd, 0x7f }, { 0x05, 0x00 }, { 0x12, 0x40 }, { 0xd3, 0x04 }, { 0xc0, 0x16 }, \
{ 0xC1, 0x12 }, { 0x8c, 0x00 }, { 0x86, 0x3d }, { 0x50, 0x00 }, { 0x51, 0x2C }, \
{ 0x52, 0x24 }, { 0x53, 0x00 }, { 0x54, 0x00 }, { 0x55, 0x00 }, { 0x5A, 0x2c }, \
{ 0x5b, 0x24 }, { 0x5c, 0x00 }, { 0xff, 0xff }

// OV2640 YUV422
#define OV2640_YUV422 \
...
{0xe0, 0x04}, {0xc0, 0xc8}, {0xc1, 0x96}, {0x86, 0x3d}, {0x50, 0x00}, {0x51, 0x90}, \
{0x52, 0x2c}, {0x53, 0x00}, {0x54, 0x00}, {0x55, 0x88}, {0x57, 0x00}, {0x5a, 0x90}, \
{0x5b, 0x2C}, {0x5c, 0x05}, {0xd3, 0x02}, {0xe0, 0x00}, {0xff, 0xff}

#if CAM_X_RES == 640
#define RESOLUTION "640x480"
#define SETRES_JPEG OV2640_640X480_JPEG
#elif CAM_X_RES == 1024
#define SETRES_JPEG OV2640_1024X768_JPEG
#define RESOLUTION "1024x768"
#elif CAM_X_RES == 1600
#define RESOLUTION "1600x1200"
#define SETRES_JPEG OV2640_1600X1200_JPEG
#else
#define RESOLUTION "320x240"
#define SETRES_JPEG OV2640_320X240_JPEG
#endif
